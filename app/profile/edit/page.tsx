...
export default function EditProfilePage() {
  ...
  const handleInputChange = (platform: keyof typeof handles, value: string) => {
  ...
  const handleSubmit = async (platform: keyof typeof handles) => {
    if (!handles[platform]) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      ...
      {/* Card Container */}
      <div className="w-full max-w-2xl bg-card rounded-[32px] shadow-xl shadow-black/5 border border-border p-8 md:p-12">
